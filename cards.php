    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">Ikramul</div>
            </a>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    classes added. Global
                                    styles are the only things modifying the look and feel of this
                                    default card example.
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Basic Card Example
                                    </h6>
                                </div>
                                <div class="card-body">
                                    The styling for this basic card example is created by using
                                    default Bootstrap
                                    utility classes. By using utility classes, the style of the card
                                    component can be
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    of a basic card. In this dropdown card example, the Font Awesome
                                    vertical ellipsis
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        ...
                                        in collapse
                                        functionality. <strong>Click on the card header</strong> to
                                        see the card body
                                        collapse and expand!
                                    </div>
                                </div>
